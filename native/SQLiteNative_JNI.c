...
/*   Java->C glue code:
 *   Java package: io.liteglue.SQLiteNative
 *    Java method: long sqlc_stp_context_create(long db)
 *     C function: sqlc_handle_t sqlc_stp_context_create(sqlc_handle_t db);
 */
JNIEXPORT jlong JNICALL 
Java_io_liteglue_SQLiteNative_sqlc_1stp_1context_1create__J(JNIEnv *env, jclass _unused, jlong db) {
  sqlc_handle_t _res;
...
/*   Java->C glue code:
 *   Java package: io.liteglue.SQLiteNative
 *    Java method: long sqlc_syn_context_create(long db)
 *     C function: sqlc_handle_t sqlc_syn_context_create(sqlc_handle_t db);
 */
JNIEXPORT jlong JNICALL 
Java_io_liteglue_SQLiteNative_sqlc_1syn_1context_1create__J(JNIEnv *env, jclass _unused, jlong db) {
  sqlc_handle_t _res;
