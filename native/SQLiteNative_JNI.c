// Note: This file used to be autogenerated but is now manually patched with
// changes from https://github.com/OutSystems/Android-sqlite-native-driver/pull/1/files
//
// Gluegen can generate bindings for returneed structs but it introduces a
// runtime dependency and a requirement to manually free the returned structs
// from Java code.
