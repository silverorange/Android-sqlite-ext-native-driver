/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Sun Apr 11 19:40:40 ADT 2021 ----! */
...
/*   Java->C glue code:
 *   Java package: io.liteglue.SQLiteNative
 *    Java method: int sqlc_tokenizer_register_all(long db, long syn_context_h)
 *     C function: int sqlc_tokenizer_register_all(sqlc_handle_t db, sqlc_handle_t syn_context_h);
 */
JNIEXPORT jint JNICALL 
Java_io_liteglue_SQLiteNative_sqlc_1tokenizer_1register_1all__JJ(JNIEnv *env, jclass _unused, jlong db, jlong syn_context_h) {
  int _res;
  _res = sqlc_tokenizer_register_all((sqlc_handle_t) db, (sqlc_handle_t) syn_context_h);
  return _res;
}
