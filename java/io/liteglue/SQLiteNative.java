...
public class SQLiteNative {
  ...
  /** Interface to C language function: <br> <code> int sqlc_tokenizer_register_all(sqlc_handle_t db, sqlc_handle_t syn_context_h); </code>    */
  public static native int sqlc_tokenizer_register_all(long db, long syn_context_h);
