...
public class SQLiteNative {
  ...
  /** Interface to C language function: <br> <code> sqlc_handle_ct *  sqlc_api_db_open(int sqlc_api_version, const char *  filename, int flags); </code>    */
  public static SQLiteResponse sqlc_api_db_open(int sqlc_api_version, String filename, int flags)  {

    ByteBuffer _res;
    _res = sqlc_api_db_open1(sqlc_api_version, filename, flags);
    if (_res == null) return null;
    return SQLiteResponse.create(Buffers.nativeOrder(_res));
  }

  /** Entry point to C language function: <code> sqlc_handle_ct *  sqlc_api_db_open(int sqlc_api_version, const char *  filename, int flags); </code>    */
  private static native ByteBuffer sqlc_api_db_open1(int sqlc_api_version, String filename, int flags);
  ...
  /** Interface to C language function: <br> <code> sqlc_handle_ct *  sqlc_db_open(const char *  filename, int flags); </code>    */
  public static SQLiteResponse sqlc_db_open(String filename, int flags)  {

    ByteBuffer _res;
    _res = sqlc_db_open1(filename, flags);
    if (_res == null) return null;
    return SQLiteResponse.create(Buffers.nativeOrder(_res));
  }

  /** Entry point to C language function: <code> sqlc_handle_ct *  sqlc_db_open(const char *  filename, int flags); </code>    */
  private static native ByteBuffer sqlc_db_open1(String filename, int flags);

  /** Interface to C language function: <br> <code> sqlc_handle_ct *  sqlc_db_prepare_st(sqlc_handle_t db, const char *  sql); </code>    */
  public static SQLiteResponse sqlc_db_prepare_st(long db, String sql)  {

    ByteBuffer _res;
    _res = sqlc_db_prepare_st1(db, sql);
    if (_res == null) return null;
    return SQLiteResponse.create(Buffers.nativeOrder(_res));
  }

  /** Entry point to C language function: <code> sqlc_handle_ct *  sqlc_db_prepare_st(sqlc_handle_t db, const char *  sql); </code>    */
  private static native ByteBuffer sqlc_db_prepare_st1(long db, String sql);
  ...
  /** Interface to C language function: <br> <code> void sqlc_handle_ct_delete(sqlc_handle_ct *  handle_ct); </code>    */
  public static void sqlc_handle_ct_delete(SQLiteResponse handle_ct)  {

        sqlc_handle_ct_delete1(((handle_ct == null) ? null : handle_ct.getBuffer()));
  }

  /** Entry point to C language function: <code> void sqlc_handle_ct_delete(sqlc_handle_ct *  handle_ct); </code>    */
  private static native void sqlc_handle_ct_delete1(ByteBuffer handle_ct);
  ...
  /** Interface to C language function: <br> <code> sqlc_handle_ct *  sqlc_stp_context_create(sqlc_handle_t db); </code>    */
  public static SQLiteResponse sqlc_stp_context_create(long db)  {

    ByteBuffer _res;
    _res = sqlc_stp_context_create1(db);
    if (_res == null) return null;
    return SQLiteResponse.create(Buffers.nativeOrder(_res));
  }

  /** Entry point to C language function: <code> sqlc_handle_ct *  sqlc_stp_context_create(sqlc_handle_t db); </code>    */
  private static native ByteBuffer sqlc_stp_context_create1(long db);

  /** Interface to C language function: <br> <code> void sqlc_stp_context_delete(sqlc_handle_t stp_context_h); </code>    */
  public static native void sqlc_stp_context_delete(long stp_context_h);

  /** Interface to C language function: <br> <code> sqlc_handle_ct *  sqlc_syn_context_create(sqlc_handle_t db); </code>    */
  public static SQLiteResponse sqlc_syn_context_create(long db)  {

    ByteBuffer _res;
    _res = sqlc_syn_context_create1(db);
    if (_res == null) return null;
    return SQLiteResponse.create(Buffers.nativeOrder(_res));
  }

  /** Entry point to C language function: <code> sqlc_handle_ct *  sqlc_syn_context_create(sqlc_handle_t db); </code>    */
  private static native ByteBuffer sqlc_syn_context_create1(long db);
