...
public class SQLiteNative {
  ...
  /** Interface to C language function: <br> <code> int sqlc_tokenizer_register_all(sqlc_handle_t db); </code>    */
  public static native int sqlc_tokenizer_register_all(long db);
