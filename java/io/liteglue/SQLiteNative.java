...
public class SQLiteNative {
  ...
  /** Interface to C language function: <br> <code> sqlc_handle_t sqlc_stp_context_create(sqlc_handle_t db); </code>    */
  public static native long sqlc_stp_context_create(long db);
  ...
  /** Interface to C language function: <br> <code> sqlc_handle_t sqlc_syn_context_create(sqlc_handle_t db); </code>    */
  public static native long sqlc_syn_context_create(long db);
