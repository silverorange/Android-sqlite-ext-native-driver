...
public class SQLiteNative {
  ...
  public static native SQLiteResponse sqlc_api_db_open(int sqlc_api_version, String filename, int flags);
  ...
  public static native SQLiteResponse sqlc_stp_context_create(long db);
  ...
  public static native SQLiteResponse sqlc_syn_context_create(long db);
